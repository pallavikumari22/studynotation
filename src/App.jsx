...
import ReviewModeration from "./components/core/Dashboard/ReviewModeration";


function App() {
  const {user}=useSelector((state)=>state.profile);
  return (
      <div className="min-h-screen w-full overflow-x-hidden bg-richblack-900 flex flex-col font-inter">
        <Navbar/>
        <Routes>
            ...
            }
            {
              user?.accountType===ACCOUNT_TYPE.ADMIN && (
                <>
                  ...
                  <Route path="/dashboard/reviews" element={<ReviewModeration/>}/>
                </>
              )
            }
          </Route>   
